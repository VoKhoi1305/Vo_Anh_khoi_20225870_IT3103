...
public class Aims {
    ...
    public static void main(String[] args) {
        //example
        store.addMedia(new DigitalVideoDisc("The Lion King", "Roger Allers", 89));
        store.addMedia(new DigitalVideoDisc("Star Wars", "George Lucas", 121));
        store.addMedia(new DigitalVideoDisc("Aladdin", "Guy Ritchie", 128));
